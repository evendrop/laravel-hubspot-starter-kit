<template>
	<div class="block justify-center items-center p-4 mx-4 mt-4 mb-6 bg-white rounded-2xl shadow-xl shadow-gray-200" >
        <div class="bg-grey-lighter px-4">
			<div class="py-5 flex justify-between">
				<div>
					<h1 class="text-3xl text-center font-bold text-gray-700">My HubSpot Hubs</h1>
				</div>
				<div>
					<a
                            href="/hs-auth"
    ...
    <div class="block justify-center items-center p-4 mx-4 mt-4 mb-6 bg-white rounded-2xl shadow-xl shadow-gray-200" >
        <div class="bg-grey-lighter min-h-[50vh]">
                    ...
                    >
                        ...
                        >
                            <div class="flex mb-4">
                                ...
                                <div
                                    class="px-4 flex whitespace-nowrap text-ellipsis overflow-hidden"
                                >
                            ...
                            <p class="mb-3 font-normal text-gray-500 text-gray-100">
                                Authenticated by<br /><strong>{{
                                    portal.hub__user_email
                                }}</strong>
                            </p>
                            <p class="mb-3 font-normal text-gray-500 text-gray-100">
                                <a
                ...
                <div class="flex justify-center" v-if="!portals?.length">
                    <div>
                        ...
                        <p class="text-center">
                            ...
                            <a
                                href="/hs-auth"
                                class="underline border-b border-blue text-blue-500"
                                >Add one now</a
                            >.<br /><br />
